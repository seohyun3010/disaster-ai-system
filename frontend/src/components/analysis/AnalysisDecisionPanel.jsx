...
const AnalysisDecisionPanel = ({ recommendedGrade, reviewStatus, onSubmit, onReviewApproved, onReviewHeld }) => {
  ...
  return <section className="case-card decision-panel">
    ...
    <div className="decision-actions"><button type="button" className="primary-action" onClick={() => setMode('approve')}>승인</button><button type="button" className="hold-action" onClick={() => setMode('hold')}>보류</button></div>
