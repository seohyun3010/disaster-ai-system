...
export const ANALYSIS_POLLING_INTERVAL = 1000;
const notConnected = () => { throw new Error('Analysis API is not connected yet.'); };
export const requestAnalysis = notConnected;
export const getAnalysisStatus = notConnected;
export const getAnalysisResult = notConnected;
export const getCaseAnalysisResult = notConnected;
export const saveAnalysisResult = notConnected;
export const submitAnalysisReview = notConnected;
