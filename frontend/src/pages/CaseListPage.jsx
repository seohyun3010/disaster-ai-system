...
const CaseListPage = () => {
  ...
  return <div className="case-page">
    <div className="case-list-integration-action"><button type="button" className="secondary-action" onClick={() => navigate('/safety24-integration')}>국민안전24 신고서 연동</button></div>
    <header className="case-page-head"><div><p>신고 관리 / 신고 목록</p><h1>재해 신고 목록</h1><span>접수된 재해 신고를 검색하고 처리 상태별로 관리합니다.</span></div><button type="button" className="primary-action" onClick={openAdd}>+ 신고 추가</button></header>
