...
const CaseListPage = () => {
  ...
  return <div className="case-page">
    <header className="case-page-head"><div><p>신고 관리 / 신고 목록</p><h1>재해 신고 목록</h1></div><div className="case-page-head-actions"><button type="button" className="primary-action" onClick={openAdd}>+ 신고 추가</button></div></header>
