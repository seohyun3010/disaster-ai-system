...
const ApprovalHistoryPage = () => {
  ...
  const filteredLogs = useMemo(() => {
    ...
    return allLogs.filter((log) => `${log.caseId} ${log.case?.reporter || ''} ${log.case?.location || ''} ${log.status || ''}`.toLowerCase().includes(term));
  }, [allLogs, search]);
